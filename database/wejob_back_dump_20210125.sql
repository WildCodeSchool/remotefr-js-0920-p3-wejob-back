...
INSERT INTO `job` VALUES (1,'developpeur',1),(2,'caissier',1),(3,'boulanger',1),(4,'patissier',2),(5,'professeur',2),(6,'animateur',1),(7,'technicien',1),(8,'vendeur',2),(9,'mecanicien',2),(10,'paysagiste',3);
...
INSERT INTO `language` VALUES (1,'francais'),(2,'anglais'),(3,'espagnol'),(4,'latin'),(5,'allemand'),(6,'chinois');
...
INSERT INTO `user` VALUES (1,'fff@ff.fr','omomom',0),(2,'jo@jo.com','dsosdhjcsdc',0),(3,'nanana@gmail.com','oisdjvoisdjvio',0);
...
--
-- Dumping data for table `user_fiche`
--

LOCK TABLES `user_fiche` WRITE;
/*!40000 ALTER TABLE `user_fiche` DISABLE KEYS */;
INSERT INTO `user_fiche` VALUES (1,'user1','user1','fhygfiufhfjodjopakvfavava','dvqdvffdv','sdqvqsdvqsdvqs','dvqsdvqsvqsdv','sdvsqdvqsdvqsdv','qsdvqsvqsvqsdvq',5,'sdfqsdfqsdfqsdfqsdfqsdfqsdf',8,0,'2021-01-03 14:55:04','2021-01-20 14:55:04',0,1,NULL,NULL),(2,'user2','user2','dsfgsfdgsdfgsdfg','gfsdgdfsg','sdfgsdfgsdfgsd','fgsdfgsdfg','sfdgsdfgsd','fgsdfgsdfgsdfg',1,'fdfdvbfdgbsfdsdf',8,0,'2021-01-25 14:55:04','2021-01-21 14:55:04',0,2,NULL,NULL);
...
INSERT INTO `user_language` VALUES (1,1,1),(2,1,2),(3,2,1),(4,2,6);
...
--
-- Dumping data for table `user_sector_of_activity`
--

LOCK TABLES `user_sector_of_activity` WRITE;
/*!40000 ALTER TABLE `user_sector_of_activity` DISABLE KEYS */;
INSERT INTO `user_sector_of_activity` VALUES (1,1,3),(2,1,12),(3,1,16),(4,1,20),(5,1,18),(6,2,2),(7,2,18),(8,2,14);
...
-- Dump completed on 2021-01-25 15:23:38
